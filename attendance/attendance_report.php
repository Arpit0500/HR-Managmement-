...
<body style="background-color: lightgray;">
	...
	<div class="box2">
		<p style="border-bottom: 2px solid orange;">Attendance List/Report</p>
		<div class="btn"><br>
		...
		<button class="btn-2" type="button"><i style="margin-left: 5px;" class="fa fa-bars"><b style="margin-left: 10px;"><a href="attendance_report.php">Attendance Report</a></b></i></button><br><br>-->
	</div>
		<table aria-label="">
			<thead>
				<tr>
