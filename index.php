                ...
                <div class="sidebar-menu">
                    ...
                    <li class="item" id="leave">
                        ...
                        <div class="sub-menu">
                            ...
                            <a href="leave/view_appln.php" target="frame"><i class="fas fa-language"></i><span> View Leave Application</span></a>
                    ...
                    <li class="item" id="project">
                        ...
                        <div class="sub-menu">
                            <a href="project/new_pro.php" target="frame"><i  class="fa fa-plus"></i><span>New</span></a>
                            <!--<a href="project/old.php" target="frame"><i></i><span>Old</span></a>-->
                        </div>
                    </li>
                     <li class="item">
                        <a href="notice/notice.php" class="menu-btn" target="frame">
